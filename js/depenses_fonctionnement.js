(function(d3) {
  ...
  var pie = d3.pie()
    .value(function(d) { return d.dep_fonct; })
    .sort(null);

  d3.csv('dep_fonct.csv', function(error, dataset) {
    dataset.forEach(function(d) {
      d.dep_fonct = +d.dep_fonct;
      d.enabled = true;
    });
    ...
    var somme_df = d3.sum(dataset, function(d) {
            ...
            var glurb = g.append("foreignObject")
                ...
                .attr("height", 100)
                .append("xhtml:h5")
                .html("DÉPENSES DE FONCTIONNEMENT <br>" + (d3.format(",")(somme_df).replace(/,/g, ' ')) + " €");
                ...
                var path = svg.selectAll('path')
                  ...
                  .on("mouseover", function(d,i) {
                   ...
                   .on("mouseout", function(d) {
                     glurb.html("DÉPENSES DE FONCTIONNEMENT <br>" + (d3.format(",")(somme_df).replace(/,/g, ' ')) + " €")
                        .style('color', "#555");
                   })
                  .each(function(d) { this._current = d; });

    var aargh = d3.select("#legend1")
...
var maxtextWidth = Math.max(...textWidth);
                ...
                aargh.selectAll("div")
                     ...
                     .style('class','a')
                      ...
                      .attr('data-target',function(d,i){return "#depfonct" + i;});

                      aargh.selectAll("div")
                            .attr('class','explain')
                            .append("text")
                            .attr('class','collapse')
                            .attr('id',function(d,i){return "depfonct" + i;})
                            .append('p')
                            .style('margin','5px 0px 5px 10px')
                            .attr('class','h3')
                            .style('font-weight','900')
                            .style('color', function(d){return color(d.data.label);})
                            .html(function(d){return (d3.format(",")(d.data.dep_fonct).replace(/,/g, ' ')) + " €";});
